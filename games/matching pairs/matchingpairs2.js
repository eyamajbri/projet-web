...
function cardClick(cardDeckValue, event) {
  ...
  if (flippedCards.length < 2 && !flippedCards.includes(card)) {
    ...
    card.style.backgroundImage = `url('C:/Users/laifi/OneDrive/Pictures/${cardDeckValue}.jpg')`;
    console.log(`url('C:/Users/laifi/OneDrive/Pictures/${cardDeckValue}.jpg')`)
      ...
      if (cardValue1 === cardValue2) {
        ...
        setTimeout(() => {
          flippedCards.forEach(card => {
            ...
            card.classList.add('hidden-card');
            card.style.backgroundImage = `url('C:/Users/laifi/OneDrive/Pictures/pattern.jpg')`;
            card.style.backgroundSize="cover";
